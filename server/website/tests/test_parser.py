...
class BaseParserTest(TestCase):
    ...
    def testConvertCatalogs(self):
        ...
        testBaseConvertKnobs = super(PostgresParser, PostgresParser(2)
                                     ).convert_dbms_knobs(testKnobs)
    ...
    def testExtractValidVariables(self):
        ...
        testEmpty, testEmptyDifflog = testDBMS.extract_valid_variables(
            {}, testDBMS.tunable_knob_catalog_)
        ...
        tuneExtract, tuneDifflog = testDBMS.extract_valid_variables(
            testVariables, testDBMS.tunable_knob_catalog_)

        self.assertTrue(('miscapitalized', 'global.wal_buffers',
                         'global.Wal_buffers', 1024) in tuneDifflog)
        ...
        nontuneExtract, nontuneDifflog = testDBMS.extract_valid_variables(
            testVariables, testDBMS.knob_catalog_)

        self.assertTrue(('miscapitalized', 'global.wal_buffers',
                         'global.Wal_buffers', 1024) in nontuneDifflog)
        self.assertTrue(('miscapitalized', 'global.geqo_effort',
                         'global.GEQO_EFFORT', 5) in nontuneDifflog)
