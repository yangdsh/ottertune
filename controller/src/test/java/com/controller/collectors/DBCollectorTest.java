/*
 * OtterTune - DBCollectorTest.java
 *
...
public class DBCollectorTest {
  ...
  public void mockJsonOutputTest() throws IOException, ProcessingException {
    String mockJsonFile1Path =
        srcPath + "/test/java/com/controller/collectors/mock_output/mockJsonOutput1.json";
    String mockJsonFile2Path =
        srcPath + "/test/java/com/controller/collectors/mock_output/mockJsonOutput2.json";
    File schemaFile = new File(schemaFilePath);
  ...
  public void outputSummaryJsonTest() throws IOException, ProcessingException {
    String summarySchemaFilePath =
        srcPath + "/main/java/com/controller/json_validation_schema/summary_schema.json";
